declare module "wasi:sockets/ip-name-lookup@0.2.0" {
  import type { Pollable } from "wasi:io/poll@0.2.0";
  import type { Network } from "wasi:sockets/network@0.2.0";
  import type { ErrorCode } from "wasi:sockets/network@0.2.0";
  import type { IpAddress } from "wasi:sockets/network@0.2.0";
  /**
