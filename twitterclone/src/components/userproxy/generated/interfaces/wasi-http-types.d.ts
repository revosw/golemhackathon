declare module "wasi:http/types@0.2.0" {
  ...
  import type { Error as IoError } from "wasi:io/error@0.2.0";
  ...
  export class Fields {
     ...
     */
    static fromList(entries: [FieldKey, FieldValue][]): Result<Fields, HeaderError>;
  }
  export class IncomingRequest {
     ...
     */
    consume(): Result<IncomingBody, void>;
  }
  ...
  export class IncomingBody {
     ...
     */
    stream(): Result<InputStream, void>;
    /**
  ...
  export class OutgoingBody {
     ...
     * will return error.
     */
    write(): Result<OutputStream, void>;
    /**
